...
val MinimalistSecondary = Color(0xFF757575)  // Medium grey
val MinimalistTertiary = Color(0xFF2196F3)  // Single accent (blue)
val MinimalistBackground = Color(0xFFFFFFFF) // Pure white
val MinimalistSurface = Color(0xFFFAFAFA)   // Off-white
val MinimalistOnPrimary = Color(0xFFFFFFFF)
val MinimalistOnSecondary = Color(0xFFFFFFFF)
val MinimalistOnBackground = Color(0xFF1A1A1A)
val MinimalistOnSurface = Color(0xFF2D2D2D)
...
val LightOnSecondaryContainer = Color(0xFF002106)
...
val DarkSecondaryContainer = Color(0xFF005313)
